...
/**
 * Collect cashiers endpoint.
 *
 * @author Serdiuk Oleksandr <serdiuk.oleksandr@gmail.com>
 */
class CollectCashiersEndpoint extends DataEndpoint
{
    /**
     * @inheritDoc
     */
     ...
     * @inheritDoc
     */
    public function getAdapted(PendingResponse $response): CollectCashiersResponse
    {
        return new CollectCashiersResponse($response);
    }
}
