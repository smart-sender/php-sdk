...
/**
 * Collect contact invoices endpoint.
 *
 * @author Serdiuk Oleksandr <serdiuk.oleksandr@gmail.com>
 */
class CollectContactInvoicesEndpoint extends DataEndpoint
{
    /**
     * @var int
     */
     ...
     * @inheritDoc
     */
    public function getAdapted(PendingResponse $response): CollectContactNotesResponse
    {
        return new CollectContactNotesResponse($response);
    }
}
