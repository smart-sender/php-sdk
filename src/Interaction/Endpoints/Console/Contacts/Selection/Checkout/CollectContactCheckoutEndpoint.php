...
namespace SmartSender\Interaction\Endpoints\Console\Contacts\Selection\Checkout;
...
/**
 * Collect contact checkout endpoint.
 *
 * @author Serdiuk Oleksandr <serdiuk.oleksandr@gmail.com>
 */
class CollectContactCheckoutEndpoint extends DataEndpoint
{
    /**
     * @var int
     */
    ...
    {
        return sprintf('contacts/%s/checkout', $this->contactId);
    }
     ...
     * @inheritDoc
     */
    public function getAdapted(PendingResponse $response): CollectContactCheckoutResponse
    {
        return new CollectContactCheckoutResponse($response);
    }
}
