 ...
 */
class CollectContactsEndpoint extends DataEndpoint
{
    /**
     * @inheritDoc
     */
     ...
     * @inheritDoc
     */
    public function getAdapted(PendingResponse $response): CollectContactsResponse
    {
        return new CollectContactsResponse($response);
    }
}
