...
/**
 * Collect channels endpoint.
 *
 * @author Serdiuk Oleksandr <serdiuk@smartsender.com>
 */
class CollectChannelsEndpoint extends DataEndpoint
{
    /**
     * @inheritDoc
     */
     ...
     * @inheritDoc
     */
    public function getAdapted(PendingResponse $response): CollectChannelsResponse
    {
        return new CollectChannelsResponse($response);
    }
}
